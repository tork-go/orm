...
// TestRelationshipMarkers_InStruct proves both marker types are usable,
// uninitialized, as fields in a model struct's composite literal, the
// same way the target API leaves Posts/Author unset.
